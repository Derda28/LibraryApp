...
public abstract class IntegrationTestBase : IDisposable
{
    ...
    public void OneTimeSetUp()
    {
        ...
        var connectionString = $"Server = SI0634\\SQL2022; Database = QimiaSchool_{Guid.NewGuid()};Trusted_Connection=True;MultipleActiveResultSets=true;TrustServerCertificate=true;";
