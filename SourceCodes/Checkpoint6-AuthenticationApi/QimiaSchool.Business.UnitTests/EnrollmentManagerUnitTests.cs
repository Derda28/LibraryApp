...
internal class EnrollmentManagerUnitTests
{
    ...
    private readonly Mock<ILogger> _mockEnrollmentLogger = null!;
    ...
    public EnrollmentManagerUnitTests()
    {
        ...
        _mockEnrollmentLogger = new Mock<ILogger>();
        _enrollmentManager = new EnrollmentManager(_mockEnrollmentRepository.Object, _mockEnrollmentLogger.Object);
    }
